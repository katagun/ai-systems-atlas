...
- Maintain a bounded provider-independent Models collection with models.dev-backed discovery and a dedicated access-and-deployability score, making reviewed releases discoverable in the common Directory while keeping labs, APIs, hosts, runtimes, applications, quality rankings, benchmarks, parameter counts, prices, and transient performance outside the model record.
