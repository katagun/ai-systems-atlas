...
- [ ] Resolve terms drift on Claude Agent SDK's license-and-terms anchor (`https://code.claude.com/docs/en/agent-sdk/overview#license-and-terms`, `systems:claude-agent-sdk:license:1`), whose evidence has not been reviewed since 2026-08-25. Read the live page, decide whether anything material changed, and advance every dated reference sharing the URL together. The DeepInfra and Baseten drifts listed alongside it were resolved on 2026-09-13 with no change to either terms text.
