...
- Clicking anywhere on a card opens its record; the card's Compare control, emblems, and hover-titled facts stay separate targets above it. The details control's accessible name names the record ("View details for Aider").
