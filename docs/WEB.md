...
24. confirm the primary navigation is plain text with an underline under the active view, that every navigation item, Blog included, is fully visible at 390px on one row and at 360px and 320px, and that the footer notices and data date align to the content column at desktop and phone widths.
