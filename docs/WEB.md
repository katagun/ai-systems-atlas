...
30. Models: a reviewed model with `source_id: null` shows "Not yet listed on models.dev" on the card and in the dialog, credits its metadata to Atlas, and is counted in the kicker.
